    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('blood_group', models.CharField(choices=[('A_P', 'A+'), ('A_N', 'A-'), ('B_P', 'B+'), ('B_N', 'B-'), ('AB_P', 'AB+'), ('AB_N', 'AB+'), ('O_P', 'O+'), ('O_N', 'O-')], max_length=4)),
                ('is_donor', models.BooleanField(default=True, verbose_name='Is Donor')),
                ('district', models.CharField(max_length=254, verbose_name='District')),
                ('local_level', models.CharField(max_length=254, verbose_name='Local Level')),
